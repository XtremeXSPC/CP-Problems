...
// Pull ContainerAliases into the global namespace BEFORE opening cp_io,
// but only when composite I/O is enabled; otherwise the user gets the
// type system as an unwanted side effect of the simple I/O profile.
