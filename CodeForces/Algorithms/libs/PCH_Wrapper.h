...
// PBDS Type Aliases - Advanced data structures with order statistics.
#if PBDS_AVAILABLE
template <typename T>
...
template <typename K, typename V>
using gp_hash_table = gp_hash_table<K, V, hash<K>, equal_to<K>, direct_mask_range_hashing<>, linear_probe_fn<>, hash_standard_resize_policy<hash_exponential_size_policy<>, hash_load_check_resize_trigger<>, true>>;
#endif
